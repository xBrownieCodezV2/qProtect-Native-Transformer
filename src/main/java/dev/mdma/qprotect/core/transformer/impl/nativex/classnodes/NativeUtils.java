...
public class NativeUtils implements Opcodes {
    ...
    public static ClassNode getClassNode(){
        ...
        }
        {
            ...
            methodVisitor.visitLineNumber(20, label19);
            ...
            methodVisitor.visitLineNumber(21, label20);
            ...
            methodVisitor.visitLineNumber(23, label21);
            methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
            ...
            methodVisitor.visitLineNumber(24, label24);
            methodVisitor.visitVarInsn(ALOAD, 0);
            methodVisitor.visitLdcInsn("/");
            ...
            methodVisitor.visitLineNumber(26, label29);
            ...
            methodVisitor.visitLineNumber(27, label30);
            methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[]{"java/lang/String", "java/lang/String", "[Ljava/lang/String;", "java/lang/String"}, 0, new Object[]{});
            methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalArgumentException");
            methodVisitor.visitInsn(DUP);
            ...
            methodVisitor.visitLineNumber(29, label31);
            methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
            ...
            methodVisitor.visitLineNumber(30, label33);
            ...
            methodVisitor.visitLineNumber(33, label32);
            methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
            ...
            methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[]{"java/lang/String", "java/lang/String", "[Ljava/lang/String;", "java/lang/String", "java/io/File", "java/io/InputStream", "java/lang/Throwable"}, 1, new Object[]{"java/lang/Throwable"});
            ...
            methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[]{"java/lang/String", "java/lang/String", "[Ljava/lang/String;", "java/lang/String", "java/io/File", "java/io/InputStream", "java/lang/Throwable", Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[]{"java/lang/Throwable"});
            ...
            methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[]{"java/lang/String", "java/lang/String", "[Ljava/lang/String;", "java/lang/String", "java/io/File"}, 0, new Object[]{});
            methodVisitor.visitJumpInsn(GOTO, label15);
            methodVisitor.visitLabel(label13);
            methodVisitor.visitLineNumber(37, label13);
            methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[]{"java/io/IOException"});
            methodVisitor.visitVarInsn(ASTORE, 5);
            Label label39 = new Label();
            methodVisitor.visitLabel(label39);
            methodVisitor.visitLineNumber(38, label39);
            methodVisitor.visitVarInsn(ALOAD, 4);
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/File", "delete", "()Z", false);
            methodVisitor.visitInsn(POP);
            Label label40 = new Label();
            methodVisitor.visitLabel(label40);
            methodVisitor.visitLineNumber(39, label40);
            methodVisitor.visitVarInsn(ALOAD, 5);
            methodVisitor.visitInsn(ATHROW);
            ...
            methodVisitor.visitLineNumber(42, label41);
            methodVisitor.visitVarInsn(ALOAD, 4);
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/File", "delete", "()Z", false);
            methodVisitor.visitInsn(POP);
            Label label42 = new Label();
            methodVisitor.visitLabel(label42);
            methodVisitor.visitLineNumber(43, label42);
            ...
            methodVisitor.visitLineNumber(49, label16);
            ...
            methodVisitor.visitLineNumber(50, label44);
            methodVisitor.visitVarInsn(ALOAD, 4);
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/File", "delete", "()Z", false);
            methodVisitor.visitInsn(POP);
            ...
            methodVisitor.visitLineNumber(52, label43);
            methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
            methodVisitor.visitVarInsn(ALOAD, 4);
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/File", "deleteOnExit", "()V", false);
            Label label46 = new Label();
            methodVisitor.visitLabel(label46);
            methodVisitor.visitLineNumber(54, label46);
            methodVisitor.visitJumpInsn(GOTO, label45);
            ...
            methodVisitor.visitLineNumber(50, label48);
            methodVisitor.visitVarInsn(ALOAD, 4);
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/File", "delete", "()Z", false);
            methodVisitor.visitInsn(POP);
            ...
            methodVisitor.visitLineNumber(52, label47);
            methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[]{"java/lang/String", "java/lang/String", "[Ljava/lang/String;", "java/lang/String", "java/io/File", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 0, new Object[]{});
            methodVisitor.visitVarInsn(ALOAD, 4);
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/File", "deleteOnExit", "()V", false);
            methodVisitor.visitLabel(label49);
            methodVisitor.visitLineNumber(54, label49);
            methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
            methodVisitor.visitVarInsn(ALOAD, 10);
            methodVisitor.visitInsn(ATHROW);
            methodVisitor.visitLabel(label45);
            methodVisitor.visitLineNumber(55, label45);
            methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[]{"java/lang/String", "java/lang/String", "[Ljava/lang/String;", "java/lang/String", "java/io/File"}, 0, new Object[]{});
            methodVisitor.visitInsn(RETURN);
            Label label50 = new Label();
            methodVisitor.visitLabel(label50);
            methodVisitor.visitLocalVariable("is", "Ljava/io/InputStream;", null, label35, label12, 5);
            methodVisitor.visitLocalVariable("e", "Ljava/io/IOException;", null, label39, label14, 5);
            methodVisitor.visitLocalVariable("e", "Ljava/lang/NullPointerException;", null, label41, label15, 5);
            methodVisitor.visitLocalVariable("path", "Ljava/lang/String;", null, label19, label50, 0);
            methodVisitor.visitLocalVariable("filename", "Ljava/lang/String;", null, label28, label50, 1);
            methodVisitor.visitLocalVariable("parts", "[Ljava/lang/String;", null, label25, label50, 2);
            methodVisitor.visitLocalVariable("string", "Ljava/lang/String;", null, label29, label50, 3);
            methodVisitor.visitLocalVariable("temp", "Ljava/io/File;", null, label11, label50, 4);
